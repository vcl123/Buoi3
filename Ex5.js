...
export default function App() {
  ...
  const imageHeight = isLandscape ? windowHeight * 0.4 : windowWidth * 0.6; // Điều chỉnh chiều cao hình ảnh theo chế độ màn hình
    ...
    >
      ...
      >
        ...
        <View style={[styles.buttonContainer, { flexDirection: isLandscape ? 'row' : 'column' }]}>
          {/* Nút 1 */}
          <TouchableOpacity
            style={[styles.button, { width: isLandscape ? windowWidth * 0.4 : windowWidth * 0.8 - 20, height: 50 }]} // Đặt độ rộng và chiều cao của mỗi nút
